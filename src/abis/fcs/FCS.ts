// Compiled ABI copied verbatim from /Users/frankencoin/Documents/frankencoin/main/abi/contracts/equity/shares/FCS.sol/FCS.json
// TODO: DELETE — replace with FCSABI export from @frankencoin/zchf once the package ships it (Phase 2)
export const FCSABI = [
	{
		"inputs": [
			{
